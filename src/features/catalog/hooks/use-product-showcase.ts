...
export const FALLBACK_PRODUCTS = [
  {
    ...
    productType: 'SIMPLE',
    name: 'Máy Chạy Bộ Điện Đa Năng Bảo An Pro X1',
    brand: 'Bảo An Sport',
  ...
  },
  {
    ...
    productType: 'SIMPLE',
    name: 'Xe Đạp Tập Thể Dục Kháng Lực Từ Bảo An AirBike',
    brand: 'Bảo An Sport',
    category: 'Xe đạp tập',
    badge: 'Giảm 25%',
  ...
  },
  {
    ...
    productType: 'SIMPLE',
    name: 'Vợt Bóng Bàn Stiga Crystal 4 Sao Chính Hãng',
    brand: 'Stiga',
    ...
    displayOriginalPrice: '1.350.000 ₫',
  },
  {
    id: 'prod-bb-2',
    slug: 'ban-bong-ban-double-fish-df-201c',
    productType: 'SIMPLE',
    name: 'Bàn Bóng Bàn Song Ngư Double Fish DF 201C Chuẩn Thi Đấu',
    brand: 'Double Fish',
    category: 'Dụng Cụ Bóng Bàn',
    badge: 'Mặt bàn MDF 18mm',
    imageUrl: 'https://images.unsplash.com/photo-1534158914592-062992fbe900?auto=format&fit=crop&w=800&q=80',
    numericPrice: 9800000,
    displayPrice: '9.800.000 ₫',
    originalPrice: 12500000,
    displayOriginalPrice: '12.500.000 ₫',
  },
  {
    id: 'prod-br-1',
    slug: 'tru-bong-ro-s206',
    productType: 'SIMPLE',
    name: 'Trụ Bóng Rổ Di Động Vành Lò Xo S206 Chuyên Nghiệp',
    brand: 'Bảo An Sport',
    ...
    displayPrice: '7.900.000 ₫',
    originalPrice: 9900000,
    displayOriginalPrice: '9.900.000 ₫',
  },
  {
    id: 'prod-bx-1',
    slug: 'bao-cat-boxing-fairtex-da-that',
    productType: 'SIMPLE',
    name: 'Bao Cát Boxing Da Thật Chịu Lực Cao Cấp Fairtex 1.2m',
    brand: 'Fairtex',
    ...
    displayOriginalPrice: '1.950.000 ₫',
  },
  {
    id: 'prod-5',
  ...
  },
  {
    ...
    productType: 'SIMPLE',
    name: 'Súng Massage Cầm Tay Trị Liệu Cơ Bắp Bảo An Recovery',
    brand: 'Bảo An Sport',
    category: 'Yoga & Phục hồi',
    badge: 'Pin 8 giờ',
