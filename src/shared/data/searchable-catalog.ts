...
export const SEARCHABLE_PRODUCTS: SearchableProduct[] = [
  // BÓNG BÀN & BÓNG RỔ (Khớp trực tiếp với hình ảnh người dùng gửi)
  {
    id: 'sp-bb-1',
    ...
    imageUrl: '/images/products/vot-stiga-crystal.jpg',
  ...
  },
  {
    ...
    imageUrl: '/images/products/vot-stiga-tube.jpg',
    badge: '5 Sao Thi Đấu',
  ...
  },
  {
    ...
    imageUrl: '/images/products/ban-double-fish-201c.jpg',
    badge: 'Chuẩn ITTF',
  ...
  },
  {
    ...
    imageUrl: '/images/products/vot-stiga-bounce.jpg',
    badge: 'Tập luyện',
  ...
  },
  {
    ...
    imageUrl: '/images/products/tru-bong-ro-s206.jpg',
