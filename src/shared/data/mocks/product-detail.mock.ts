...
export const MOCK_PRODUCT_DETAILS: Record<string, MockProductDetail> = {
  'may-chay-bo-dctd-pro-x1': {
    ...
    shortDescription: 'Máy chạy bộ điện thông minh Bảo An Pro X1 với động cơ 3.5HP êm ái, thảm chạy kim cương 7 lớp chống chấn thương, kết nối Bluetooth thông minh và gập gọn thủy lực tiện lợi.',
    ...
    variants: [
      {
        ...
        bundle: {
          ...
          components: [
            ...
            { componentVariantId: 'comp-2', componentName: 'Ghế vớt tạ điều chỉnh 7 nấc Bảo An', quantity: 1 },
  ...
  'vot-bong-ban-stiga-crystal-4-sao': {
    id: 'prod-bb-1',
    productNo: 'PRD-BB-001',
    name: 'Vợt Bóng Bàn Stiga Crystal 4 Sao Chính Hãng',
    slug: 'vot-bong-ban-stiga-crystal-4-sao',
    brand: 'Stiga',
    primaryCategory: 'Dụng Cụ Bóng Bàn',
    productType: 'SIMPLE',
    status: 'ACTIVE',
    version: 1,
    minPrice: '950000',
    currency: 'VND',
    imageUrl: 'https://images.unsplash.com/photo-1609710228159-0fa9bd7c0827?auto=format&fit=crop&w=1200&q=85',
    shortDescription: 'Vợt bóng bàn cao cấp Stiga Crystal 4 sao công nghệ gia tốc WRB Thụy Điển, độ nảy bóng uy lực, kiểm soát bóng chuẩn xác đạt chuẩn ITTF quốc tế.',
    description: 'Cốt vợt 5 lớp gỗ tuyển chọn gia công nhiệt chân không, lớp mút cao su Stiga Crystal 2.0mm tăng tốc độ xoáy topspin tối đa, cán cầm rỗng WRB phân bổ trọng tâm đòn đánh linh hoạt.',
    variants: [
      {
        id: 'var-bb-1-1',
        sku: 'BA-STIGA-FL',
        name: 'Cán Loe (Flared Handle - FL) Cầm chắc tay',
        effectivePrice: '950000',
        inventoryQuantity: 40,
      },
      {
        id: 'var-bb-1-2',
        sku: 'BA-STIGA-ST',
        name: 'Cán Thẳng (Straight Handle - ST) Xoay vợt nhanh',
        effectivePrice: '950000',
        inventoryQuantity: 25,
      },
    ],
    techSpecs: [
      { label: 'Thương hiệu', value: 'Stiga Thụy Điển' },
      { label: 'Chứng nhận', value: 'ITTF Approved (Chuẩn thi đấu quốc tế)' },
      { label: 'Tốc độ (Speed)', value: '85 / 100' },
      { label: 'Độ xoáy (Spin)', value: '75 / 100' },
      { label: 'Kiểm soát (Control)', value: '70 / 100' },
      { label: 'Độ dày mút', value: '2.0 mm cao su tự nhiên bám xoáy' },
      { label: 'Bảo hành', value: '12 tháng chính hãng Bảo An Sport' },
    ],
    media: [],
    categories: [],
    categoryIds: [],
  },
  'ban-bong-ban-double-fish-df-201c': {
    id: 'prod-bb-2',
    productNo: 'PRD-BB-002',
    ...
    minPrice: '9800000',
    currency: 'VND',
    imageUrl: 'https://images.unsplash.com/photo-1534158914592-062992fbe900?auto=format&fit=crop&w=1200&q=85',
    shortDescription: 'Bàn bóng bàn thi đấu Double Fish DF 201C mặt gỗ MDF 18mm phủ sơn chống chói lóa, chân thép hộp 40x40mm bánh xe xoay 360 độ khóa chốt an toàn.',
    description: 'Được liên đoàn bóng bàn thế giới chứng nhận, khung viền thép 40mm chống cong vênh độ ẩm cao nhiệt đới, cơ cấu gấp đôi độc lập cho phép tự tập 1 người dễ dàng.',
    variants: [
      {
        id: 'var-bb-2-1',
        sku: 'BA-DF201C-STD',
        name: 'Trọn Bộ Bàn + Cọc Lưới Thi Đấu',
        effectivePrice: '9800000',
        inventoryQuantity: 15,
      },
      {
        id: 'var-bb-2-2',
        sku: 'BA-DF201C-FULL',
        name: 'Combo Bàn + Lưới + 2 Cặp Vợt Song Ngư + 10 Bóng',
        effectivePrice: '10600000',
        inventoryQuantity: 10,
      },
    ],
    techSpecs: [
      { label: 'Thương hiệu', value: 'Double Fish (Song Ngư)' },
      { label: 'Độ dày mặt bàn', value: 'MDF chất lượng cao dày 18 mm phủ sơn UV đa lớp chống lóa' },
      { label: 'Kích thước lắp đặt', value: '2740 x 1525 x 760 mm (Chuẩn Olympic ITTF)' },
      { label: 'Khung chân', value: 'Thép hộp vuông 40 x 40 mm sơn tĩnh điện chống rỉ sét' },
      { label: 'Bánh xe di chuyển', value: '8 bánh xe đường kính 75mm có khóa phanh hãm' },
      { label: 'Trọng lượng bàn', value: '85 KG' },
      { label: 'Bảo hành', value: '24 tháng, hỗ trợ vận chuyển và lắp ráp tận nhà miễn phí' },
    ],
    media: [],
    categories: [],
    categoryIds: [],
  ...
  'tru-bong-ro-s206': {
    ...
    shortDescription: 'Trụ bóng rổ di động ngoài trời S206 bảng kính cường lực Acrylic trong suốt, vành đúc lò xo kép dunk úp rổ an toàn, nâng hạ độ cao linh hoạt 2.3m – 3.05m.',
    description: 'Thùng đối trọng dung tích 150 lít chứa nước hoặc cát đảm bảo vững chãi trước gió bão, trang bị 2 bánh xe chịu lực phía trước giúp di chuyển sân bãi thuận tiện.',
    variants: [
      {
        id: 'var-br-1-1',
        sku: 'BA-S206-ACRYLIC',
        name: 'Bản Bảng Kính Acrylic 136x80cm Vành Lò Xo',
        effectivePrice: '7900000',
        inventoryQuantity: 20,
      },
      {
        id: 'var-br-1-2',
        sku: 'BA-S206-PRO',
        name: 'Bản Kèm Đệm Bọc Thân Trụ An Toàn + Quả Bóng Da Số 7',
        effectivePrice: '8500000',
        inventoryQuantity: 12,
      },
    ],
    techSpecs: [
      { label: 'Thương hiệu', value: 'Bảo An Sport' },
      { label: 'Chiều cao vành rổ', value: 'Điều chỉnh vô cấp từ 2.30 m đến 3.05 m (Chuẩn thi đấu FIBA)' },
      { label: 'Chất liệu bảng rổ', value: 'Kính chịu lực Acrylic cao cấp 1360 x 800 mm dày 10mm viền nhôm' },
      { label: 'Vành rổ', value: 'Thép đặc phi 16mm kèm hệ thống giảm chấn lò xo đôi chịu lực dunk 120kg' },
      { label: 'Đế thùng trụ', value: 'Nhựa đúc thổi HDPE 130 x 80 x 20 cm, chứa 150kg nước hoặc 180kg cát' },
      { label: 'Bảo hành', value: '24 tháng ngoài trời' },
    ],
    media: [],
    categories: [],
    categoryIds: [],
  },
  'bao-cat-boxing-fairtex-da-that': {
    id: 'prod-bx-1',
    productNo: 'PRD-BX-001',
    name: 'Bao Cát Boxing Da Thật Chịu Lực Cao Cấp Fairtex 1.2m',
    slug: 'bao-cat-boxing-fairtex-da-that',
    brand: 'Fairtex',
    primaryCategory: 'Dụng Cụ Võ Thuật',
    productType: 'SIMPLE',
    status: 'ACTIVE',
    version: 1,
    minPrice: '1450000',
    ...
    shortDescription: 'Bao cát đấm bốc Fairtex chính hãng nhập khẩu Thái Lan chất liệu da Microfiber 3 lớp bền gấp 2 lần da bò, xích treo xoay 360 độ chống xoắn dây.',
    description: 'Chuyên dụng cho tập luyện Muay Thai, Kickboxing, Boxing cường độ cao. Đệm lót mút xốp phân tán lực chấn động bảo vệ cổ tay và khớp đốt ngón tay tối đa.',
    variants: [
      {
        id: 'var-bx-1-1',
        sku: 'BA-FAIRTEX-1M2',
        name: 'Chiều Dài 1.2m (Đã nhồi sẵn 35kg)',
        effectivePrice: '1450000',
        inventoryQuantity: 30,
      },
      {
        id: 'var-bx-1-2',
        sku: 'BA-FAIRTEX-1M5',
        name: 'Chiều Dài 1.5m (Đã nhồi sẵn 45kg)',
        effectivePrice: '1850000',
        inventoryQuantity: 18,
      },
    ],
    techSpecs: [
      { label: 'Thương hiệu', value: 'Fairtex Thailand' },
      { label: 'Chất liệu vỏ', value: 'Syntek Leather cao cấp chống xé rách, chống thấm nước' },
      { label: 'Lõi nhồi bên trong', value: 'Vải vụn ép thủy lực + Mút xốp đàn hồi EVA' },
      { label: 'Dây treo', value: 'Dây đai sợi Nylon siêu bền kèm xích thép mạ kẽm và khớp xoay 360°' },
      { label: 'Bảo hành', value: '12 tháng đường may và phụ kiện treo' },
    ],
    media: [],
    categories: [],
    categoryIds: [],
...
export function getMockProductDetail(slug: string): MockProductDetail | null {
  if (MOCK_PRODUCT_DETAILS[slug]) {
    return MOCK_PRODUCT_DETAILS[slug];
  }
  // Dynamic fallback for demo slugs
  const defaultProduct = MOCK_PRODUCT_DETAILS['may-chay-bo-dctd-pro-x1'];
