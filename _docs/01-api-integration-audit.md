...
> **Version:** 1.0.0  
> **Updated:** 2026-09-08  
> **Summary:** Rà toàn bộ đường gọi API và chuẩn hóa cấu trúc checkout theo feature-first.
...
| Orders/payment/fulfillment | Chưa có API Sprint 4 | Không tự tạo mock contract thay backend |
